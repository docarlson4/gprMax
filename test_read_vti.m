...
% Developed in Matlab 9.12.0.2039608 (R2022a) Update 5 on PCWIN64.
% Doug Carlson (doug.o.carlson@gmail.com), 2022-12-14 20:23

%%

[filename, pathname] = uigetfile('*.vti', 'Select VTK file');
fullfilename = strcat(pathname, filename);

[vertex,face] = read_vtk(fullfilename)
